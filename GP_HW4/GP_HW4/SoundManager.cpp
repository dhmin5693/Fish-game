...
bool CSoundManager::init(HWND hWnd)
{
	...
	{
		MessageBox(hWnd, TEXT("Error initializing DirectSound.  Sample will now exit."),
			TEXT("DirectSound Sample"), MB_OK | MB_ICONERROR);
		return false;
	}
...
bool CSoundManager::add(LPWSTR filename, int *id)
{
	// Create a sound file
